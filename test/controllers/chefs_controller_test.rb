...
class ChefsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chef" do
    assert_difference("Chef.count") do
      post chefs_url, params: { chef: { email: @chef.email, name: @chef.name, phone: @chef.phone, specialty: @chef.specialty } }
    end
  ...
  test "should update chef" do
    patch chef_url(@chef), params: { chef: { email: @chef.email, name: @chef.name, phone: @chef.phone, specialty: @chef.specialty } }
